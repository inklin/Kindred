...
import myUpdateReducer      from './content/my-update'
import commentReducer       from './content/comment'
import loadingReducer       from './content/loading'
import currentUserReducer   from './current-user'
import contactReducer       from './contact'

export { digestReducer, sectionReducer, updateReducer, loadingReducer, commentReducer, currentUserReducer, myUpdateReducer, contactReducer }
